...
public class Functions {
	...
	/**
	 * Constructor for the Class "Functions" sets the parameter "product" of the
	 * Class to the passed parameter to the Constructor "product"
	 * 
	 * @param product
	 */
	...
	/**
	 * CreateRelationGraph creates a new Instance of the Object
	 * {@link specificDepthRetrieval.RelationSearcher} and calls its method
	 * {@link specificDepthRetrieval.RelationSearcher#FindRelations()} and then
	 * stores the result of the call to
	 * {@link RelationSearcher#getFunctionMethod()} to the field FUnctions of
	 * type List<String>
	 */
	...
	/**
	 * returns the List<String> Functions containing all the Function Names
	 * already Created
	 * 
	...
	/**
	 * opens a serialization file called product_functions.ser which contains
	 * the List<String> Functions which is what this object is mostly about
	 * 
	 * @param product
	 */
	@SuppressWarnings("all")
	public void DeserializeFunctions(String product) {
		List<String> RelAndEIDs = new ArrayList<>();
		try {
	...
	/**
	 * Serializes the List<String> Functions contained in this instance of the
	 * object @see {@link Functions}
	 * 
	 * @param product
	...
	/**
	 * receives as parameter a String and returns true if given string is equal
	 * to a member of the List<String> Functions or false if it is not
	 * 
	 * @param s
	 * @return
	 */
	...
	/**
	 * Returns the RelationsSearcher created in @see
	 * {@link Functions#CreateRelationGraph()}
	 * 
	 * @return
	 */
