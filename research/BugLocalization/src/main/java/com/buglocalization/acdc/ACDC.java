...
/**
 * This application facilitates the task of recovering the structure of large and complex software systems in an automatic way by
 * clustering.
 * <p>
 * The data structure used to represent the components of the software system is a tree, which is clustered incrementally by using several
 * patterns.
 * <p>
 * Assumptions made: ACDC will cluster the children of the root in the input. Once an object has been clustered, it is never removed from
 * its cluster (but it might get further clustered within its cluster)
 */
public class ACDC
{

    /**
     * Exits the program with an error message which reminds the user how to run this application. The string s represents the concatenation
     * of characters representing allowable clustering patterns to be used in this program, e.g. 'b' - body-header pattern, 's'- subgraph
     * pattern , 'o' - orphan adoption etc.
     *
     * @param run_name
     */
    ...
    /**
     * Returns true if the string s1 is made up only of characters found in the string s2; else returns false.
     */
    ...
    public static void main(String[] args)
    {
        ...
        for (String arg1 : args)
        {
            if (arg1.equals("-6431"))
            {
                run_name = "com/buglocalization/acdc";
            }
        }
